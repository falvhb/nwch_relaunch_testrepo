...
import DemoDataMap from 'higher-order/iso-map-test';
...
const Demo = React.createClass({
  ...
  testInteraction() {
    console.log('woo-hoo client-side JS!');
  },

  render() {
    return (
      <article itemScope='' itemType='http://schema.org/Article' onClick={this.testInteraction}>
        <div className="teaser teaser-6col" style={{backgroundColor: '#fff4db'}}>
          <div className="teaserImageHolder asset_image">
            <img src width="460" height="272" />
          </div>
...
export default DemoDataMap(Demo);
