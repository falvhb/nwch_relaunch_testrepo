...
const Viewer = React.createClass({
  ...
  render() {
    ...
    var sections = [
      ...
      {
        title: 'JSX',
        content: <Loading key='jsx'><Highlight className='html'>{this.removeTabs(ReactToJsx(this.props.children))}</Highlight></Loading>
      },
      {
        title: 'HTML',
        content: <Loading key='html'><Highlight className='html'>{React.renderToStaticMarkup(this.props.children)}</Highlight></Loading>
      },
      {
        title: 'Data',
        content: this.props.json
          ? <Loading key='data'><Highlight className='json'>{JSON.stringify(this.props.json, null, 2)}</Highlight></Loading>
