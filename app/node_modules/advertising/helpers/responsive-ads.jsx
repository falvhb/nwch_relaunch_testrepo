import { _map } from 'lodash/collection';
import { _assign } from 'lodash/object';
...
function getAdSlotConfig(placements) {
  ...
  var slotBounds = _map(placements, function (placement) {
    ...
    placementConfig = _assign(placementConfig, placementBounds);
