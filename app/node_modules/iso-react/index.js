...
module.exports = function(selector) {
  ...
  var createReactComponent = function(params) {
    var el = React.createElement(params.component, params.state);
    return React.renderToString(el, params.state, params.meta);
  };
  ...
  var wrap = function(params) {
    ...
    var stateData = escapeHtml(JSON.stringify(params.state || {}));

    var wrapClasses = classNames.wrap;
    wrapClasses += ' ' + classNames.wrap + '--' + params.meta.id;

    var html;
    html =  '<div class="' + wrapClasses + '" data-meta="' + metaData + '">';
  ...
  var hydrate = function(components) {
    ...
    for (var i = 0, len = isos.length; i < len; i++) {
      ...
      if (!components[component]) {
        throw 'Add hydration of ' + component + ' to client.js or do not use the Iso wrapper for this component if client-side rendering is not required. This is configured in slot.js in the component folder.';
      } else {
