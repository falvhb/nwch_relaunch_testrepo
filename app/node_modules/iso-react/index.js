...
module.exports = function(selector) {
  ...
  var wrap = function(params) {
    ...
    var html;
    html =  '<div class="' + classNames.wrap + '" data-meta="' + escapeHtml(JSON.stringify(params.meta)) + '">';
    html += '<div class="' + classNames.component + '">';
    html += createReactComponent(params);
    html += '</div>';
    html += '<span aria-hidden="true" class="' + classNames.state + '" data-state="' + escapeHtml(JSON.stringify(getShallowData(params))) + '"></span>';
    html += '</div>';
