...
const defaultView = 'small';

import getTeaserData from './get-from-article';
import getVariationConfig from './get-switch-view-config';
...
export default function(data) {
  ...
  const config = getVariationConfig(article);
  ...
  _.forEach(views, (view) => {
    ...
    let variationData = getTeaserData(variationParams);
