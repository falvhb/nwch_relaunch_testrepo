...
export default function(props, state) {
  ...
  return {
    ...
    image: _.get(config, 'image')
      ? _.merge({}, _.get(props, 'image'), config.image)
      : false,
    byline: _.get(config, 'byline')
      ? _.merge({}, _.get(props, 'byline'), config.byline)
      : false,
    summary: _.get(config, 'summary')
      ? _.merge({}, _.get(props, 'summary'), config.summary)
      : false,
    catchword: _.get(config, 'catchword')
      ? _.merge({}, _.get(props, 'catchword'), config.catchword)
      : false,
  };
}
