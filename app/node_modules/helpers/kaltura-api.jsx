...
export default class KalturaAPI {
  constructor(options) {
    ...
    this.setFilter(options.freeText, options.mediaTypeEqual, options.categoriesIdsMatchOr);
  ...
  setFilter(freeText, mediaTypeEqual, categoriesIdsMatchOr) {
    this.freeText = freeText + '*';
    this.mediaTypeEqual = mediaTypeEqual;
    this.categoriesIdsMatchOr = (categoriesIdsMatchOr ? categoriesIdsMatchOr : '');
  }
  ...
  getURL() {
    this.url = this.protocol
                ...
                + this.path
                + '?action='+this.action
                + '&filter:categoriesIdsMatchOr='+this.categoriesIdsMatchOr
