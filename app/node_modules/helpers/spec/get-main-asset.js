...
describe('Helpers', () => {
  ...
  describe('getMainAsset', () => {

    let fixture;

    beforeEach(function() {
      fixture = article.article.assets;
    });

    it('ignores non-image assets above it', () => {
      let expected = fixture[1];
      let result = getMainAsset(fixture);
      expect(result).to.equal(expected);
    });

    it('returns an image gallery', () => {
      let expected = fixture[1];
    ...
    it('returns the next item when image does not have a source', () => {
    ...
    it('returns the next item when video does not have an image', () => {
      let expected = fixture[3];
    ...
    it('returns null for non image assets', () => {
      let expected = null;
