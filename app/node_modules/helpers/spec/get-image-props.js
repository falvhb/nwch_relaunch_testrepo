...
describe('Helpers', function() {
  ...
  describe('getImageProps', function() {
    ...
    it('returns caption as title when there is no alt', function() {
      ...
      clone.description = null;
      let result = getImageProps(clone);
      expect(result.title).to.contain('© ');
    });
    ...
    it('returns asset src as a fallback for galleries', function() {
      let firstImage = _.first(galleryFixture.asset.images);
    ...
    it('returns asset src as a fallback for videos', function() {
    ...
    it('returns null when image has no src', function() {
      let clone = _.assign({}, imageFixture);
      clone.image_url = null;
    ...
    it('returns null when video has no image', function() {
      let clone = _.assign({}, videoFixture);
      clone.asset = {};
      let result = getImageProps(clone);
      expect(result).to.equal(null);
