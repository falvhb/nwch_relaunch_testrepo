// the View classes mimicing the existing zope functionality
...
import "./assets.jsx";
import {ImageGallery, RelationVideo} from './assets';
import {getRelationFor} from "./registry.jsx";
...
// unit test exists
  ...
  get mainTeaserAssetUrl() {
    ...
    if (mainAssetRelation instanceof RelationVideo) {
      return mainAssetRelation.getImageUrl(this._teaserSize);
    }

    return mainAssetRelation ? mainAssetRelation.imageUrl : null;
  }
...
//               )
  ...
  // unit tests exist - modified may be
