...
*/
  ...
  get mainAssetUrl() {
    ...
    if (mainAsset) {
      if (mainAsset.asset.content_type === "asset_image") {
        return mainAsset.image_url;
      } else if (mainAsset.asset.content_type === "asset_video") {
        // if still_image.asset.content_type == "asset_image"
        // then return sth. with still_image.asset.media_digest ...
        return mainAsset.image_url;
      } else if (mainAsset.asset.content_type === "asset_image_gallery") {
        // if images[0].asset.content_type == "asset_image"
        // then return sth. with images[0].asset.media_digest ...
        return mainAsset.image_url;
      } else if (mainAsset.asset.content_type === "asset_document") {
        // return download_url
        return mainAsset.image_url;
      } else if (mainAsset.asset.content_type === "asset_audio") {
        // if still_image.asset.content_type == "asset_image"
        // then return sth. with still_image.asset.media_digest ...
        return mainAsset.image_url;
      } else if (mainAsset.asset.content_type === "asset_htmlsnippet") {
        // return ???
        return mainAsset.image_url;
      } else if (mainAsset.asset.content_type === "asset_survey") {
        // if teaser.asset.content_type == "asset_image"
        // then return sth. with ???
        // or from answers[0].teaser.asset.media_digest ...
        return mainAsset.image_url;
      } else if (mainAsset.asset.content_type === "asset_quiz") {
        // if teaser.asset.content_type == "asset_quiz"
        // then return sth. with teaser.asset.media_digest ...
        return mainAsset.image_url;
      }
    }
  }
  ...
  getTeaserUrl(width, height, letterbox = true) {
    let mainAssetUrl = this.mainAssetUrl;
    if (mainAssetUrl) {
      return createImageSrc(mainAssetUrl, width, height, letterbox)
    } else {
      return "";
    }
  }

  // unit test exists // TODO
