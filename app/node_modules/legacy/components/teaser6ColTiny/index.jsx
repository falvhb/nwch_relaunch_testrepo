...
/*
<!-- teaser6Col full but tiny image -->
<metal:macro define-macro="teaser6ColTiny">
<div class="teaser teaser-6col tiny">
  ...
  <div class="tiny-right"
       tal:omit-tag="not:view/providesTeaserCompatibleMainAsset">
...
export default class Teaser6ColTiny extends React.Component {

  constructor(props) {
    super(props);
    //this.view = new View(this.props.article, { width: 460, height: 272 });
    this.view = new View(this.props.article, { width: 220, height: 130 });
    //this.view = new View(this.props.article, { width: 140, height: 82 });
  }
