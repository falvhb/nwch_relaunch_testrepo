...
/**
 * article_macros.pt#articleImage6Col - for grepping ...
 */

/*
 <metal:macro define-macro="articleImage6Col">
   <div tal:attributes="class python: 'teaserImageHolder ' + view.mainAssetType()"
     ...
     <a href=""
       ...
       <img src="" alt="" title=""
            width="460"
            height="272"
            tal:attributes="src context/@@teaser_url/medium" />
...
export default class ArticleImage6Col extends React.Component {
