...
export default React.createClass({
  ...
  enrichContent() {
    ...
    // While there are tokens in the content, keep going
    while (index > -1) {
      ...
      // If we still have interferers left to display, push the component in the
      // `chunks` array
      } else if (interfererIndex < this.props.stoerer.length) {
      ...
      // If we have too many tokens for the amount of interferers we had to
      // display, break the loop 'cause it's over
      } else {
        break;
      }
