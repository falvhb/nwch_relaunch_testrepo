...
export default React.createClass({
  ...
  getStoerers() {
    ...
    while (index > -1) {
      ...
      var interferer = this.props.data.stoerer[interfererIndex];
  ...
  getMainAsset() {
    if (this.props.data.assets.length > 0) {
      return React.createElement(
        this.getStoererComponent(this.props.data.assets[0].asset.content_type),
        this.props.data.assets[0]
      );
    }
  ...
  render() {
    ...
    return (
      <div {...classes()}>
        ...
        <Tags keywords={this.props.data.keywords} />
      </div>
    );
  }
