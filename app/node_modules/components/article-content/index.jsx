...
export default React.createClass({
  ...
  enrichmentToken: 'stoerer',
  curatedToken: 'empfehlung',
  ...
  isCuratedToken(index, text) {
    var token = this.formatToken(this.curatedToken);
  ...
  enrichContent() {
    var chunks = [];
    var text = this.purgeText(this.props.text);
    var curated = false;
    var interfererIndex = 0;
    var rawIndex = 0;
    var token = this.getRegExp([this.curatedToken, this.enrichmentToken]);
    ...
    if (text.length > 0) {
      ...
      text = text.replace(this.formatToken(this.enrichmentToken), '');
