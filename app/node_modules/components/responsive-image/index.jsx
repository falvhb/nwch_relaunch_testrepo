    ...
    if (support) {
      ...
      img = (
        <noscript dangerouslySetInnerHTML={{ __html: React.renderToStaticMarkup(
          <picture>
            <source itemProp="contentUrl" {...classes('img')} srcSet={this.responsiveImageSrc({ src: src, size: 'wide', ratio: ratio, letterbox: letterbox })} media="(min-width:680px)" />
            <source itemProp="contentUrl" {...classes('img')} srcSet={this.responsiveImageSrc({ src: src, size: 'large', ratio: ratio, letterbox: letterbox })} media="(min-width:450px)" />
            <source itemProp="contentUrl" {...classes('img')} srcSet={this.responsiveImageSrc({ src: src, size: 'regular', ratio: ratio, letterbox: letterbox })} media="(min-width:320px)" />
            <source itemProp="contentUrl" {...classes('img')} srcSet={this.responsiveImageSrc({ src: src, size: 'mobile', ratio: ratio, letterbox: letterbox })} />
