    ...
    if (support) {
      ...
      img = (
        <noscript dangerouslySetInnerHTML={{ __html: React.renderToStaticMarkup(
          <picture>
            <source {...classes('img')} srcSet={this.responsiveImageSrc({ src: src, size: 'max', ratio: ratio, letterbox: letterbox })} media="(min-width:640px)" />
            <source {...classes('img')} srcSet={this.responsiveImageSrc({ src: src, size: 'large', ratio: ratio, letterbox: letterbox })} media="(min-width:500px)" />
            <source {...classes('img')} srcSet={this.responsiveImageSrc({ src: src, size: 'medium', ratio: ratio, letterbox: letterbox })} media="(min-width:320px)" />
            <source {...classes('img')} srcSet={this.responsiveImageSrc({ src: src, size: 'small', ratio: ratio, letterbox: letterbox })} />
