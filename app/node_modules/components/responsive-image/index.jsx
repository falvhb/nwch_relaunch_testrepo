      ...
      image = (
        <noscript dangerouslySetInnerHTML={{ __html: React.renderToStaticMarkup(
          <picture {...classes('', [props.ratio, props.size, 'fallback'])} alt={props.alt}>
            <source itemProp="contentUrl" {...classes('img')} srcSet={this.responsiveImageSrc({ src: props.src, size: 'huge', ratio: props.ratio })} media="(min-width:960px)" />
            <source itemProp="contentUrl" {...classes('img')} srcSet={this.responsiveImageSrc({ src: props.src, size: 'large', ratio: props.ratio })} media="(min-width:640px)" />
