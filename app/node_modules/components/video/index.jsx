...
const Video = React.createClass({
  ...
  getPlayerLibraryURLs() {
    // var playerID = (forPlayerWithoutAds === true) ? this.playerID : this.props.playerWithoutAdsID;
    return 'http://cdnapi.kaltura.com/p/1719221/sp/171922100/embedIframeJs/uiconf_id/26605721/partner_id/1719221';
  ...
  render() {
    return (
      ...
      <div {...classes('container--outer')} itemProp='video' itemScope itemType='http://schema.org/VideoObject'>
        <div {...classes('container--inner')} ref='videoContainer' id={this.props.kalturaID} />
        <Caption
          title={this.props.title}
          description={this.removePTags(this.props.description)}
