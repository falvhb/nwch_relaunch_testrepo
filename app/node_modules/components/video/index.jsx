  ...
  unmuteAndPlayPlayerWithAds() {
    ...
    if (!this.props.autoPlay || this.isMobile()) {
      ...
      kdp.kBind('preSequenceStart', function() {
        ...
        kdp.kUnbind('.tracking');

        self.track(Tracking.EVENT, {
          event: 'adPlay',
          id: self.props.kaltura_id || null
        });
      });

      // Track when video starts to play (after ad has played)
      kdp.kBind('firstPlay.tracking', function() {
        self.track(Tracking.EVENT, {
          event: 'videoPlay',
          id: self.props.kaltura_id || null
        });
      ...
      // Track when video is replayed
      kdp.kBind('doReplay.tracking', function() {
        self.track(Tracking.EVENT, {
          event: 'videoReplay',
          id: self.props.kaltura_id || null
        });
