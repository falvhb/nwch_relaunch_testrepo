...
const Video = React.createClass({
  ...
  propTypes: {
    kaltura_id: React.PropTypes.object.isRequired,
  ...
  loadPlayers() {
    ...
    var self = this;
    jQuery.when(
      jQuery.getScript( this.getPlayerLibraryURLs() ),
      ((self.props.autoPlay) ? jQuery.getScript( this.getPlayerLibraryURLs()) : true ), // do not load player without ads if autoPlay is deactivated
  ...
  render() {
    ...
    return (
      <figure {...classes()} itemProp='video' itemScope itemType='http://schema.org/VideoObject'>
        ...
        <Caption {...caption} />
        {Object.keys(meta).map(function(metaItem) {
          return <meta itemProp={metaItem} content={meta[metaItem]} />;
        })}
      </figure>
    );
