...
const Video = React.createClass({
  ...
  render() {
    ...
    var { kaltura_id, title, description, source, thumbImageURL } = this.props;

    return (
      <div {...classes('container--outer')} itemProp='video' itemScope itemType='http://schema.org/VideoObject'>
        <div {...classes('container--inner')} ref='videoContainer' id={kaltura_id} />
        <Caption
          title={title}
          description={stripMarkup(description)}
          source={getSource(source)} />
        <meta itemProp='thumbnailUrl' content={thumbImageURL} />
      </div>
