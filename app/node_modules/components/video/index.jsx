...
const Video = React.createClass({
  ...
  loadPlayers: function() {
    ...
    var self = this;
    jQuery.when(
      jQuery.getScript( "http://cdnapi.kaltura.com/p/"+self.props.accountID+"/sp/"+self.props.accountID+"00/embedIframeJs/uiconf_id/"+self.props.playerID2+"/partner_id/"+self.props.accountID+"" ),
      jQuery.getScript( "http://cdnapi.kaltura.com/p/"+self.props.accountID+"/sp/"+self.props.accountID+"00/embedIframeJs/uiconf_id/"+self.props.playerID+"/partner_id/"+self.props.accountID+"" ),
  ...
  render() {
    return (
      <div {...classes('container--outer')} >
        <div {...classes('container--ratio--enforcer')} ></div>
