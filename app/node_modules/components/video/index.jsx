...
export default React.createClass({
  ...
  installTracking(kdp, id) {
    ...
    this.configureInVideoTracking(kdp, id);
  ...
  configureInVideoTracking(kdp, id) {
    this.configureSeekTracking(kdp, id);

    this.configurePlayPauseTracking(kdp, id);
  },

  configureSeekTracking(kdp, id) {
    var self = this;

    // Only trigger seeking if we are not pausing.
    // Otherwise 2 trackings would fire (doPlay & doSeek)
    var isPlaying = false;
    ...
    kdp.kBind(this.appendSuffix('doPlay.setPlaying', id), function() {
      isPlaying = true;
    });
    kdp.kBind(this.appendSuffix('doPause.setPlaying', id), function() {
      isPlaying = false;
    });
    kdp.kBind(this.appendSuffix('doStop.setPlaying', id), function() {
      isPlaying = false;
    });
  },

  configurePlayPauseTracking(kdp, id) {
    var self = this;
    ...
    kdp.kBind(this.appendSuffix('doPlay.install', id), function() {
      ...
      self.installPlayPauseTracking(kdp, id);
    });
    ...
    // uninstall play pause tracking on stopping
    this.addPlayPauseUninstaller(kdp, id);
  },

  addPlayPauseUninstaller(kdp, id) {
    var self = this;
    ...
    kdp.kBind(this.appendSuffix('doStop.uninstall', id), function() {
      ...
      self.removePlayPauseTracking(kdp, id);
    });
  },

  installPlayPauseTracking(kdp, id) {
    var self = this;
    var _id = id;
  ...
  removePlayPauseTracking(kdp, id) {
