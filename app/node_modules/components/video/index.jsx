...
export default React.createClass({
  ...
  componentDidMount() {
    this.loadPlayers({
      playerID: az.globals.kaltura_frontend_video_player_id || process.env.KALTURA_PLAYER_ID,
      playerWithoutAdsID: az.globals.kaltura_frontend_adless_video_player_id || process.env.KALTURA_PLAYER_NOADS_ID
    });
  },
