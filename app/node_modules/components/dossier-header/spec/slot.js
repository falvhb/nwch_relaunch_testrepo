...
import state from 'utils/data/master-dossier';
...
describe('DossierHeader', function() {
  ...
  describe('slot', function() {
    ...
    it('data contains title and text', function() {
      expect(fixture.title).to.be.a('string');
      expect(fixture.text).to.be.a('string');
    });

    it('data contains a background', function() {
