...
import RessortTeaserBuilder from 'higher-order/ressort-teaser-builder';
      ...
      <section {...classes()}>
        <Container>
          ...
          <footer {...classes('footer')}>
            {ressortUrl && title ?
              <a href={ ressortUrl } {...classes('cta')}>
                <span {...classes('cta-label')}>Mehr artikel in { title }</span>
                <Icon id='arrow-right' {...classes('cta-icon')} />
              </a>
            : null}
            <div {...classes('rule')} />
          </footer>
