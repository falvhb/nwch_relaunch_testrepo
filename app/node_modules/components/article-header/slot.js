...
function getBannerType(article) {
  if (article.sponsor && article.sponsor.text) {
    return SPONSORED;
...
function blocksForBannerType (bannerType, article) {
  function authorBlock(article, text) {
    var author = _.get(article, 'owner') || {} ;
  ...
  function sponsorBlock(article) {
    var sponsor = _.get(article, 'sponsor', {});
  ...
  function clubBlock(article, type) {
    var club = _.get(article, 'for_content') || {} ;
