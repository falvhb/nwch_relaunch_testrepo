...
describe('ArticleHeader', function() {
  ...
  describe('slot', function() {
    ...
    it('data has an author / source', function() {
      expect(_.has(fixture, 'author')).to.be.true;
      expect(_.has(fixture, 'source')).to.be.true;
    });

    it('data has a published date', function() {
      expect(_.has(fixture, 'published')).to.be.true;
    });

    it('data has a modified date', function() {
      expect(fixture.modified).to.be.a('string');
    });
