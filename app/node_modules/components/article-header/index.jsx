    ...
    return (
      <header {...classes()}>
        ...
        <div {...classes('meta', null, 'type-detail')}>
          <p itemProp='author' {...classes('author', null)}>{this.props.author} – {this.props.source}</p>
          {this.props.modifieddate && this.props.modifieddate !== this.props.publicationdate
            ? <p itemProp='dateModified' {...classes('date')}>Zuletzt aktualisiert am {this.formatDate(this.props.modifieddate)}</p>
            : <p itemProp='dateCreated' {...classes('date')}>{this.formatDate(this.props.publicationdate)}</p>
          }
        </div>
      </header>
    );
