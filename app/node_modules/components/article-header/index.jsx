...
export default React.createClass({
  ...
  render() {
    ...
    return (
      <header {...classes()}>
        <p itemProp='genre' {...classes('catchword', null, 'type-tiny-header')}>{this.props.context_label}</p>
        <h1 itemProp="headline" {...classes('title', null, 'type-h1')}>{this.props.title}</h1>
        <div {...classes('meta', null, 'type-detail')}>
          <p itemProp='author' {...classes('author', null)}>von {this.props.author} – {this.props.source.title}</p>
