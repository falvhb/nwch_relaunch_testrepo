...
.image-gallery.is-gallery-loading .flickity-viewport,
...
.image-gallery.is-fullscreen .image-gallery__nav-bar {
  position: fixed;
  top: auto;
  bottom: 0;
}

.image-gallery.is-fullscreen .image-gallery__nav,
.image-gallery.is-fullscreen .image-gallery__nav::before {
  height: 100%;
}
