...
const ImageGallery = React.createClass({
  ...
  initSlider() {
    ...
    var self = this;
    var wrapper = this.refs.imageGalleryElement.getDOMNode();
    var slider = wrapper.querySelector(this.flickityElement);

    this.flickity = new Flickity(slider, this.flickityOptions);
    setTimeout(function() {
      self.setState({ loading: false });
      self.flickity.resize();
    }, 500);
