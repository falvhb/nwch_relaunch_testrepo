...
describe('RessortHeader', function() {
  ...
  describe('slot', function() {
    ...
    it('data has a url part', function() {
      expect(fixture.urlpart).to.be.a('string');
    });

    it('data has a subnav', function() {
      expect(fixture.subnav).to.be.an('array');
    });

    it('with the correct number of items', function() {
      expect(fixture.subnav.length).to.equal(9);
    });

    it('containing a urlpart / title', function() {
      let subressort = _.first(fixture.subnav);
      expect(_.has(subressort, 'urlpart')).to.be.true;
