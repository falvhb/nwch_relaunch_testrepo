...
/**
 * Teaser image (if any)
 * 1. We will in slightly
 * 2. On hover
 * 3. Brighten the image (as we have a light bg)
 ...
 */
.teaser--promoted .teaser__title,
.teaser--promoted .teaser__supplementary,
.teaser--promoted .teaser__catchword {
  color: inherit;
}
