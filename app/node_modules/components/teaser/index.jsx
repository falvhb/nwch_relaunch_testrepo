...
export default React.createClass({
  ...
  render() {
    ...
    let modifierClasses = [variation].concat(_.get(theme, 'modifiers'));
    let bylineLabel =  _.get(theme, 'type');
    let autoplayIcon = _.get(theme, 'name') === 'autoplay';
