    ...
    return (
      <article {...classes(null, [modifier, theme])} itemScope itemType='http://schema.org/Article'>
        <a {...classes('inner')} href={link} itemProp='url'>
          {image
            ? <div {...classes('image')} itemProp='image'>
                <ResponsiveImage {...image} defer={true} fill={true} itemScope itemType='http://schema.org/ImageObject'/>
              </div>
          :null}
          <footer {...classes('footer')}>
            ...
            :null}
            <h1 {...classes('title')} itemProp='name'>{title}</h1>
            {supplementary
              ? dateFormat
