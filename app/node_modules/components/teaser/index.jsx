...
import { getViewportWidth, getTeaserResponsiveState } from 'helpers';
...
export default React.createClass({
  ...
  isResponsiveTeaser(variation) {
    return _.contains(this.responsiveTeasers, variation || this.props.variation);
  },
  ...
  componentDidMount() {
    ...
    if (this.isResponsiveTeaser()) {
      ...
      // console.log('add listener', this.state);
