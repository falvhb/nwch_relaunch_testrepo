...
export default React.createClass({
  ...
  handleResize() {
    this.setState({
      view: getViewportWidth() <= this.props.responsive.breakpoint
        ? 'small'
        : 'large'
    });
  },
  ...
  render() {
    ...
    let { variation, responsive, theme, title, link, catchword, summary, byline, image, marker, schema } = this.props;
