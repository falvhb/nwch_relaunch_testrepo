...
export default React.createClass({
  ...
  render() {
    ...
    var { modifier, theme, title, catchword, link, image, dateFormat, supplementary, schema } = this.props;
      ...
      <article {...classes(null, [modifier, theme])} itemScope itemType='http://schema.org/Article'>
        <a {...classes('inner')} href={link} itemProp='url'>
          {image
            ...
            : schema && schema.imageUrl
              ? <meta itemProp='image' content={schema.imageUrl} />
              :null}
          <footer {...classes('footer')}>
            ...
            {schema && schema.datePublished ?
              <meta itemProp='datePublished' content={schema.datePublished} />
            :null}
            {schema && schema.dateModified ?
              <meta itemProp='dateModified' content={schema.dateModified} />
            :null}
            {supplementary
              ? dateFormat
