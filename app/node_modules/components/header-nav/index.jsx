...
export default React.createClass({
  ...
  checkScrollPosition() {
    if (document.body.scrollTop > 150 && this.state.isScrollNavHidden) {
  ...
  render() {
    ...
    if (id && domainVariations.length <= id) {
      navItems.splice(1, 0,
        {
          href: domainVariations[id].href,
          label: domainVariations[id].label
        }
      );
    }
