...
export default React.createClass({
  ...
  domainVariations: [
    {
      href: 'http://aargauerzeitung.ch',
      label: 'Aargau'
    },
    {
      href: 'http://bzbasel.ch',
      label: 'Basel'
    },
    {
      href: 'http://basellandschaftlichezeitung.ch',
      label: 'Basel'
    },
    {
      href: 'oltnertagblatt.ch',
      label: 'Solothurn'
    },
    {
      href: 'http://grenchnertagblatt.ch',
      label: 'Solothurn'
    },
    {
      href: 'http://solothurnerzeitung.ch ',
      label: 'Solothurn'
    },
    {
      href: 'http://limmattalerzeitung.ch',
      label: 'Limmattal'
    },
    {
      href: 'http://badenertagblatt.ch ',
      label: 'Aargau'
    }
  ],
        ...
        <div className="header-nav__scroll-main">
          <div className="header-nav__container">
            <a className="header-nav__scroll-logo" href="/" title="Startseite">
              <img src="/__node__/__static__/client/images/az-nwch-logo-noname.svg" />
            </a>
            <button onClick={this.toggleScrollSubNavigation} className="header-nav__scroll-menu-button">
              <img
                className="header-nav__scroll-menu-icon"
  ...
  render() {
    ...
    const domainVariations = this.domainVariations.slice();

    if (variation in domainVariations) {
      navItems.splice(1, 0, {
        href: domainVariations[variation].href,
        label: domainVariations[variation].label
      });
    }
        ...
        <div className="header-nav__brand">
          <div className="header-nav__container">
            ...
            <a href="/" title="Startseite">
              <img className="header-nav__logo header-nav__logo--notext" src="/__node__/__static__/client/images/az-nwch-logo-noname.svg" />
              <img className="header-nav__logo header-nav__logo--text" src="/__node__/__static__/client/images/az-nwch-logo-name.svg" />
            </a>
          </div>
        </div>
        <nav className={"header-nav__container"+(this.state.isHidden ? ' header-nav--hidden' : '')}>
