...
=======
>>>>>>> add flickity and add veeseo classes to scss-lint.xml
...
<<<<<<< HEAD
<<<<<<< HEAD
  flickityElement: '.veeseoRA2VW2 li',
=======
  flickityElement: '#veeseoRA2VW.veeseoRA2VW',
>>>>>>> add flickity and add veeseo classes to scss-lint.xml
=======
  flickityElement: '.veeseoRA2VW2 li',
>>>>>>> delete all css nesting and config flickityElement
...
=======
      <div {...classes()}>
        <Container>
          <h3 {...classes('title')}>Verwandte Videos</h3>
          <div className="veeseoRA2VW2"></div>
          <script src="http://rce.veeseo.com/widgets/aargauerzeitung/widget.js"></script>
        </Container>
      </div>
>>>>>>> delete all css nesting and config flickityElement
    );
