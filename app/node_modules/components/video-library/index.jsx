...
const VideoLibrary = React.createClass({
  ...
  selectVideo(videoID) {
    ...
    this.track('selectVideo', videoID);
  },

  deselectVideo() {
    this.setState({selectedVideo: null});

    this.track('deselectVideo', this.state.selectedVideo);
  },
  ...
  search() {
    ...
    this.track('search', this.state.searchText);
  },
  ...
  increasePageIndex() {
    ...
    this.track('nextPage', this.state.searchText, this.state.pageIndex);
  },
