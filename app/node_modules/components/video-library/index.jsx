...
// loading status of videos
// @TODO:@Richard: Can I use constant that can be accessed as static properties of a react component?
const IS_LOADED = 0;
// const IS_LOADING = 1;
...
const VideoLibrary = React.createClass({
  ...
  setVideos(videos) {
    ...
    this.setState({
      ...
      loadingStatus: this.constants.IS_LOADED,
      skipGetVideos: true
    });
  },
