...
import KalturaAPI from 'helpers/video/kaltura-api';
import extractSource from 'helpers/video/extract-source';
...
const VideoLibrary = React.createClass({
  ...
  propTypes: {
    ...
    initialSelectedVideo: React.PropTypes.string,
    initialVideoSource: React.PropTypes.string,
    initialTotalCount: React.PropTypes.number.isRequired,
    kalturaAPIDomain: React.PropTypes.string.isRequired,
    ...
    kaltura: React.PropTypes.shape({
      kalturaSession: React.PropTypes.string.isRequired
    }).isRequired
  },
  ...
  getInitialState() {
    return {
      ...
      selectedVideo: this.props.initialSelectedVideo,
      videoSource: this.props.initialVideoSource,
  ...
  loadVideos() {
    ...
    var kalturaAPI = new KalturaAPI({
      ...
      ks: this.props.kaltura.kalturaSession
    });
  ...
  loadSource() {
    ...
    kalturaAPI.getData().then((response) => {
      let sourceParsed = extractSource(response);
      this.setState({
