/* global KalturaConfiguration: true, KalturaBaseEntryFilter: true, KalturaClient: true, VideoLibrary: true */
...
export default React.createClass({
  ...
  statics: {
    loadKalturaClient: function() {
      ...
      // @TODO:@Richard: is this the right way to load and execute scripts?
      axios.get('/client/scripts/vendor/KalturaClient.min.js')
      .then(function() {
        // console.log('axios.get Kaltura Client:', response);
