...
var KalturaAPI = require('helpers/image/kaltura-api.jsx');

module.exports = function(req) {
  // console.info('============= api.js called: ', __filename);

  // console.info('TEMP: api data: ', req.api._data);
  // console.info('Domain data already available in api.js: ',
  //   'kaltura_mediathek_category_id: ', req.api._data.domain.data.properties.kaltura_mediathek_category_id,
