...
describe('Expander', () => {
  ...
  describe('renders', () => {
    ...
    beforeEach(() => {
      props = data[0].data;
      props.onSetExpandableHeight = sinon.spy();
  ...
  describe('notifies', () => {
    ...
    it('when its height has been set', () => {
      Test(<Expander {...props} />)
        .element(() => {
          props.onSetExpandableHeight.should.have.been.called;
        });
    });
  ...
  describe('adds', () => {
    ...
    it('the item\'s height to its original height and notifies of the new height', () => {
      ...
      component.addToHeight(100);

      expect(props.onSetExpandableHeight).to.have.been.calledTwice;
      props.onSetExpandableHeight.should.have.been.calledWithMatch(100);
      expect(component.getDOMNode().firstChild.style.height).to.equal('100px');
    });
