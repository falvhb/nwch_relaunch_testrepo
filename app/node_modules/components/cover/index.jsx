...
export default React.createClass({
  ...
  render() {
    ...
    let { variation, title, catchword, link, linkText, image, background } = this.props;
        ...
        <a {...classes('link')} href={link}>
          <div {...classes('inner')}>
            ...
            {image
              ? (
                <div {...classes('image')}>
                  <ResponsiveImage {...image} fill={true} rounded={true} />
                </div>
              )
            :null}
            {linkText
              ? <p {...classes('link-text')}>
                  <span {...classes('link-text-inner')}>{linkText}</span>
