...
export default React.createClass({
   ...
   */
  getItemprop() {
    return this.isPublication() ? 'datePublished' : 'dateModified';
  },
  ...
  render() {
    ...
    return (
      <span>
        <time itemProp={this.getItemprop()} dateTime={moment(this.chooseDate()).toISOString()}>
          {this.displayDate()}
        </time>
        {this.isModification() ?
          <meta itemProp='datePublished' content={moment(this.props.publicationDate).toISOString()} />
        :null}
      </span>
    );
