 ...
 */
.category-overview .grid__item > *::before {
  position: absolute; /* 1 */
  content: '';
 ...
 */
.category-overview .grid__item:nth-child(n+2) > *::before {
...
.category-overview .grid__item:last-child > *::before,
.category-overview .grid__item:nth-child(even):nth-last-child(2) > *::before {
  @include media('>grid-break-1', '<=grid-break-2') {
    display: none; /* 4 */
  }
}
 ...
 */
.category-overview .grid__item:nth-child(n+2) > *::before,
.category-overview .grid__item:nth-child(n+3) > *::before {
  @include media('>grid-break-2') {
    width: 1px; /* 1 */
    left: -10px; /* 2 */
    top: 10px; /* 3 */
