...
export default React.createClass({
  ...
  render() {
    ...
    var loadingClasses = {
      'is-loading': this.props.loadingStatus === 1,// VideoLibrary.constants.IS_LOADING ?
      'is-failed': this.props.loadingStatus === 2// VideoLibrary.constants.LOADING_FAILED ?
    };
    ...
    return (
      <div {...classes(null, 'container', loadingClasses)}>
        {content}
