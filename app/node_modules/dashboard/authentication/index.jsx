    ...
    if (this.isLoginType()) {
      ...
      return (
        <div>
          ...
          <TextInput className="form-row" name="password_confirmation" value={ this.state.password_confirmation } label="Passwort bestätigen" onChange={this.onChange} type="password" required='required' />
          <Checkbox className="form-row" name="accepted_agc" value={ this.state.accepted_agc } label="Ich have die Geschäftsbedingungen gelesen und bin damit einverstanden" onChange={this.onChange} required='required' />
        </div>
      )
    }
  },
