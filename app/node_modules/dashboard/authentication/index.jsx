    ...
    if (isLoggedIn()) {
      return (
        <Container modifiers='small'>
          <div {...classes('heading')}>
            <SectionHeader title='Sie sind bereits angemeldet'/>
            Wenn Sie sich abmelden möchten, klicken Sie bitte auf “Abmelden” im oberen Teil des Bildschirms.
          </div>
        </Container>
      )
    }
        ...
        <form {...classes()} onSubmit={ this.onFormSubmit }>
          ...
          <div {...classes('form')}>
            ...
            <div className="form-row">
              <input type="submit" disabled={this.state.submitting} className="form__submit button button--submit" value={action} />
            </div>
          </div>
        </form>
      </Container>
