...
export default Component => React.createClass({
  ...
  displayName: 'ReactTeaserBuilder',

  propTypes: {
    title: React.PropTypes.string,
    articles: React.PropTypes.array,
    slots: React.PropTypes.oneOf([3, 5, 8]).isRequired
  },
  ...
  render() {
    ...
    return <Component {...this.props} items={items.slice(0, slots)} modifier={slots === 3 ? 'three-up-simple' : 'three-up-featured'}/>;
  }
