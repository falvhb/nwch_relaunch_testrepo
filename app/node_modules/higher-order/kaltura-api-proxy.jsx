...
// import { KalturaAPIClient } from 'helpers';
...
export default React.createClass({
  ...
  loadVideos() {
    ...
    this.getVideos().then((response) => {
      ...
      // @TODO: show busy spinner while loading
      // this.setState({loading: false});
    }).catch(function () {
      // @TODO: show alert component if error occured
      this.setState({loadError: true}); // render error message in render function if set
    });
  },
  ...
  componentDidUpdate() {
    if (!this.props.skipGetVideos) {
      /*
      var client = new KalturaAPIClient({
        ssl: false,
      ...
      client.getVideos(this.props.onSetVideos);
      */
      this.loadVideos();
    }
