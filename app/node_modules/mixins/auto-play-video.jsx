...
export default {
  ...
  onScreenChangeHandlingOfPlayerWithoutAds() {
    ...
    var onScreenCurrently = jQuery('#' + this.props.kaltura_id).isOnScreen();
  ...
  setupPlayerWithAds() {
    ...
    var initPlayerWithAds = function(i) {
      ...
      var kdp = document.getElementById(self.props.kaltura_id);
      var triggerPlayerReplacement = function() {

        if (self.state.inReplacementMode) {
          kWidget.destroy(self.props.kaltura_id);
