...
export default {
  ...
  setupFlickity(component) {
    window.addEventListener('resize', _.debounce(component.startResize, 250, { leading: true }));
    window.addEventListener('resize', _.debounce(component.stopResize, 250, { trailing: true }));
