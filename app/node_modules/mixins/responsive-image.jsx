...
const ResponsiveImageMixin = {
  ...
  getScreenSize() {
    ...
    // Responsive Image
    var viewport = this.state.viewport || this.getViewportWidth();
  ...
  handleResize() {
    this.setState({ viewport: this.getViewportWidth() });
  }
