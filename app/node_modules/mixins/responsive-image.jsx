...
export default {
  ...
  fitToBox() {
    ...
    if (wrapperDims.width > imgDims.width && imgDims.width > imgDims.height) {
      console.log('fixtobox', wrapperDims, imgDims);
      let percentageLarger = (wrapperDims.width / imgDims.width * 100);
      img.style.width = percentageLarger + '%';
    }

    // portrait images
    if (wrapperDims.height > imgDims.height && imgDims.height > imgDims.width) {
      let percentageLarger = (wrapperDims.height / imgDims.height * 100);
      img.style.height = percentageLarger + '%';
    }
  },
