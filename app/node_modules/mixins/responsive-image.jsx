...
export default {
  ...
  imageWidthFromSizeVariation(variation) {
    let fallback = imageConfig.standardImageSizes[fallbackType];
    ...
    if (!imageConfig.imageVariations[variation]) {
      console.warn('ResponsiveImage size "' + variation + '" not found, using fallback "' + fallbackType + '"');
      return fallback;
    }
    ...
    if (!imageSize) {
      console.warn('ResponsiveImage variation "' + viewport + '" not found for "' + variation + '" size, using fallback "' + fallbackType + '"');
      return fallback;
    }
  ...
  responsiveImageSrc(params) {
    var imageWidth = this.imageWidthFromSizeVariation(params.size);
