...
export default {
  ...
  createImageSignature(params) {
    var size = '/'.concat(params.width, 'x', params.height, (params.fill ? ',fill' : ''));
    var signature = CryptoJS.HmacSHA1(size, params.salt);
    var encodedSignature = this.base64Encode(CryptoJS.enc.Base64.stringify(signature));
