...
import VideoLibraryContent from 'components/video-library-content';
import VideoLibraryPreview from 'components/video-library-preview';
...
export default React.createClass({
  ...
  getInitialState() {
    return {
      ...
      kaltura: {
        categoryId: '21939571',
        ks: 'djJ8MTcxOTIyMXxcM-06UvOvIYskV0AlrUu9pc3VszD9JqSjTnrznOElmk0tUYIS3bN_np9rWxriBbtwBtOdgP86b8mD0hSj6X-4iUDFlXIHszUTwXWLMcNujw=='
      },
      videos: null
    };
  },
  ...
  render() {
    return (
      <Container>
        ...
        <VideoLibraryHeader searchText={this.state.searchText} changeSearchText={this.changeSearchText}/>
          <a onClick={this.search}>suchen</a>
        <VideoLibraryContent/>
        <VideoLibraryPreview videos={this.state.videos}/>
      </Container>
    );
  }
