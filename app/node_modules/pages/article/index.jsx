        ...
        <article itemScope itemType='http://schema.org/Article'>
          ...
          <Container>
            <div className='wrapper'>
              <div className='main'>
                <div className='az-iso--articleIntro'>
                  <ArticleIntro {...this.props} />
                </div>
                <div className='az-iso--articleDetail'>
                  <ArticleDetail {...this.props} />
                </div>
                <RecommendationsTop articles={this.props.teasersTop} />
              </div>
              <div className='sidebar'></div>
            </div>
          </Container>
        </article>
        <RecommendationsBottom articles={this.props.teasersBottom} />
        <RelatedVideos />
      </div>
    );
  }
