...
describe('Net Metrix Tracker\'s method', () => {
  ...
  describe('trackPageView', () => {
    ...
    it('fires tracking', () => {
      NetMetrixTracker._track = sinon.spy();
  ...
  describe('_track', () => {
    it('does fire tracking or just log if we are not on a live host', () => {
      ...
      t.getTag = sinon.spy();
      t.isLiveHost = sinon.spy();
      // sinon.spy(NetMetrixTracker, 'isLiveHost');
      t._requestTag = sinon.spy();
      t._log = sinon.spy();
      ...
      // t.isLiveHost.should.have.returned(tag);
      ...
      // t._requestTag.not.should.have.been.called;
