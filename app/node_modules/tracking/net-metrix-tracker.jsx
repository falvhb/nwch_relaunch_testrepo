...
export default class NetMetrixTracker {
  ...
  static _log(tag, type) {
    console.info(`Detected Net Metrix tag of type '${type}' not fired as current host "${window.location.host}" is not whitelisted as live host using the flag "no_wemf" in domain configuration of the cms. Net Metrix tag is: `, tag);
  }

  static isLiveHost() {
    // @TODO: check `no_wemf` flag from domain configuration of cms.
    return true;
  }
