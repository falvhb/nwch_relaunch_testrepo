 ...
 * as live host using the flag `no_wemf` in domain configuration of the cms.
...
export default class Tracker {
   ...
   *
   * @example
   * Tracker.isNetMetrixLiveHost();
   *
   * @return  {Boolean}  Returns `true` if the current host is a live host.
   */
  static isNetMetrixLiveHost() {
    return NetMetrixTracker.isLiveHost();
  }
