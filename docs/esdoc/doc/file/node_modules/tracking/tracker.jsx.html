...
<head>
  ...
  <title data-ice="title">node_modules/tracking/tracker.jsx | API Document</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">node_modules/tracking/tracker.jsx</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">// import GoogleAnalyticsTracker from &apos;tracking/google-analytics-tracker&apos;;
...
export default class Tracker {
   ...
   * @param  {string}   [data.path.id]       - The ID of the data or the component or the page displayed. Use this field if you want to specify something such as am ID of a video or a keyword of a search.
   * @param  {string}   [data.path.paging]    - The paging information. Example: For the image gallery this is the index of the image requested.
